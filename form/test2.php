        ...
        <div id="main">
            <header class="major">
               <?php
                ...
                mysql_query("Answers2'cp1251'");
                mysql_select_db('Answers2', $link);
                ?>
                <?php
                ...
                $answer = array(
                    '0', 'Университет', 'Ухо', 'Автомобилисты', 'Куй железо, пока горячо',
                    'Человек-невидимка', 'Артисткой', 'Пауза', 'Её падение', 'Темно', 'Четверо'
                );
                ...
                $sql = mysqli_query($link, "INSERT INTO `Answers2` (`Username`, `Question1`, `Question2`,`Question3`,`Question4`,`Question5`,`Question6`,`Question7`,`Question8`,`Question9`,`Question10`, `Result`, `Date`, `UserAgent`) 
