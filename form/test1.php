...
<head>
    <title>Результаты викторины №1</title>
    <meta charset="utf-8" />
        ...
        <div id="main">
            <header class="major">
               <?php
                ...
                mysql_query("Answers'cp1251'");
                mysql_select_db('Answers', $link);
                ?>
                <?php
                ...
                $sql = mysqli_query($link, "INSERT INTO `Answers` (`Username`, `Question1`, `Question2`,`Question3`,`Question4`,`Question5`,`Question6`,`Question7`,`Question8`,`Question9`,`Question10`, `Result`, `Date`, `UserAgent`) 
